  ...
  useEffect(() => {
    ...
    const provideSuggestion = async () => {
      try {
        ...
        // Improved prompt to get structured suggestions
        const prompt = `Analyze the following ${type} and provide 3-5 specific improvement suggestions.
                ...
                4. Start each point with "**Category:** " (e.g., "**Grammar:** Fix subject-verb agreement")`
    ...
    <main>
      {loading ? (
        ...
        <div className="textTract">
          ...
          <div className="extractedText">{ansText}</div>
          <div className="scoreCon">
            ...
            <div className="suggestion">
              <p>
                {type} Score: {score} <i className={`fi ${emojiClass} emoji`}></i>
              </p>
